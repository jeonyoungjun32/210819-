...
NATURAL JOIN
------------ insert.jsp ----------
select NVL(max(w_workno),0)+1 from tbl_worklist;
-------------select.jsp----------------------
select w_workno, p_code, p_name, p_p1, p_p2, p_p3,p_p4, p_p5, p_p6, w_lastdate, w_lasttime
from tbl_product natural join tbl_process 
where w_workno = 20190001;
